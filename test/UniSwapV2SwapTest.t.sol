...
contract UniswapV2SwapExamplesTest is Test {
    ...
    function testSwapSingleHopExactAmountIn() public {
        ...
        console.log("Money Before Sending ether :",address(this).balance / 1e18);
        ...
        console.log("Money after sending ether :",address(this).balance / 1e18);
        uint dai_balance = dai.balanceOf(address(this));
        uint dai_balance1 = dai.balanceOf(address(uni));
        console.log("Dai balance in testing contract :",dai_balance / 1e18);
        console.log("Dai balance in testing contract :",dai_balance1 / 1e18);
